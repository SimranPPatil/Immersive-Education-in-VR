...
public class AnswerSelect6 : MonoBehaviour
{
    ...
    {
        print(correct);
        if (correct != 0 && correct < 430)
        {
            ship.transform.Rotate(Vector3.down * speedOfRotation, 20 * Time.deltaTime);
            correct++;
        }
        if (correct >= 430 && correct < 140030)
        {
        ...
        if (correct == 19000003)
        {
            ...
            star.enabled = true;
            next.GetComponent<AnswerSelect7>().enabled = true;
            curr.GetComponent<AnswerSelect6>().enabled = false;
        ...
        {
            if (flagA == false && flagB == false && flagC == true && flagD == true)  //////////////////////////////////////////////////////////////////////////////
            { //shoot
