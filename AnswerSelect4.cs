...
public class AnswerSelect4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (correct == 225)
        {
            ...
            star.enabled = true;
            next.GetComponent<AnswerSelect5>().enabled = true;
            curr.GetComponent<AnswerSelect4>().enabled = false;
        ...
        {
            if (flagA == false && flagB == true && flagC == false && flagD == false)  //////////////////////////////////////////////////////////////////////////////
            { //shoot
