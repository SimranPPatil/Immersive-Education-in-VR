...
public class AnswerSelect2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(correct == 199)
        {
            ...
            curr.GetComponent<AnswerSelect2>().enabled = false;
        ...
        {
            if (flagC == true && flagB == false && flagA == false && flagD == false)  //////////////////////////////////////////////////////////////////////////////
            { //shoot
