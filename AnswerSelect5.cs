...
public class AnswerSelect5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            ship.transform.Rotate(Vector3.right * speedOfRotation, 20 * Time.deltaTime);
            correct++;
        }
        if (correct >= 50 && correct < 165)
        {
        ...
        if (correct == 165)
        {
            ...
            curr.GetComponent<AnswerSelect5>().enabled = false;
        ...
        {
            if (flagA == true && flagB == false && flagC == false && flagD == true)  //////////////////////////////////////////////////////////////////////////////
            { //shoot
