...
public class AnswerSelect7 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (correct == 375)
        {
            ...
            ring.enabled = false;
            next.enabled = true;
            curr.GetComponent<AnswerSelect7>().enabled = false;

            //next.GetComponent<AnswerSelect3>().enabled = true;
        }
        print(flagA);
        //flag = flag2;
        ...
        {
            if (flagA == true && flagB == true && flagC == false && flagD == false)  //////////////////////////////////////////////////////////////////////////////
            { //shoot
